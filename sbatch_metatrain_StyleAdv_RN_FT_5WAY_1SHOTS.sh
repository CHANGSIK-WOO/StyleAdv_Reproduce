...
#SBATCH --job-name=metatrain_StyleAdv_RN_FT_5way_1shot
#SBATCH --nodes=1
#SBATCH --gres=gpu:1
#SBATCH -p batch
#SBATCH -w vgi1
...
# ChestX 데이터셋
python3 finetune_StyleAdv_RN.py --testset ChestX --name exp-FT-ChestX --train_aug --n_shot 1 --finetune_epoch 10 --finetune_LR 0.005 --resume_dir exp-name/RN_5WAY_1SHOTS --resume_epoch -1
