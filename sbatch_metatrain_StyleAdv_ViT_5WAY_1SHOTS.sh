...
python metatrain_StyleAdv_ViT.py --output output/ViT_5WAY_1SHOTS --dataset mini_imagenet --epoch 20 --lr 5e-5 --arch dino_small_patch16 --device cuda:0 --nSupport 1 --fp16
